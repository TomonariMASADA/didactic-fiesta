B in being settled by a particular A to a particular B, i.e., B in A->B, is some content that fills up the actuallity of the interpretant and more precisely speaking is a coordination of an indefinite number of properties (species sensibiles).
